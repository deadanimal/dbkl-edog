					...
					<div class="block-title">
						<div class="block-options pull-right">
							<div class="form-inline">
								<strong>Tahun :
									<?php
									echo "<select name=\"year\" id=\"year-address\" class=\"form-control\">";
						...
						<h2><strong>Berikut ialah senarai alamat permohonan</strong></h2>
					</div>
					<small>
						<!-- <form action="<?php // echo base_url('admin') 
											?>/index.php/adress_list/index" name="search-form" id="search-form" method="get">
							<div class="col-md-3">
							...
							<table id="datatable-baru" class="table table-condensed table-striped table-bordered">
								<thead>
									<tr class="warning">
										...
										<td class="col-sm-2 "><strong>Nama Pemohon</strong></td>
										<td class="col-sm-6 "><strong>Alamat</strong></td>
										<td class="col-sm-1 text-center"><strong>Tindakan</strong></td>
									</tr>
								</thead>
								<tbody>
									<?php
									...
									foreach ($already as $ready) {
										...
										if ($row->status == "Lulus") {
											...
											// echo "<a href=\"".base_url('admin')."/index.php/approved/index/".$row->app_id."\" class=\"btn btn-xs btn-success\" href=\"jkas_form_app.html\"> Semakan </a>";
											echo "<a href=\"" . base_url('admin') . "/index.php/validate_apps/index/" . $ready->app_id . "\" target=\"_blank\"><b>" . $ready->app_no . "</b></a>";
										}
										echo "</div>
											</td>
											</tr>";
