				...
				<div class="block bordered full">
					...
					<div class="block-title">
						...
						<ul class="nav nav-tabs" data-toggle="tabs">
							<li class="active">
								<a href="#tabs-user-details">Butiran Pemohon</a>
							</li>
							<li><a href="#tabs-dog-details">Butiran Anjing</a></li>
							<li><a href="#tabs-action">Status</a></li>
							<li><a href="#tabs-reject">Pembatalan</a></li>
						</ul>
					</div>
							...
							<div class="row">
								<!-- <form id="user-details" action="page_forms_wizard.html" method="post" class="form-horizontal"> -->
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_email">Bill</label>
											<div class="col-md-6">
												<?php if($info[0]->doc_bill != ''){ ?>
													<a href='<?php echo base_url().$info[0]->doc_bill; ?>' target='_blank'>
														<img src="<?php echo base_url().$info[0]->doc_bill; ?>" width="70%">
													</a>";
												<?php }else{ ?>
						...
						<div class="tab-pane" id="tabs-reject">
							<div class="row">
								<!-- <form id="user-details" action="page_forms_wizard.html" method="post" class="form-horizontal"> -->
									...
									<?php if($doc_cancel == 0){ ?>
									<div class="col-sm-6">
										<div class="row sub-header pt-2">
											<h4>Pembatalan Lesen</h4>
										</div>
