        ...
        <div id="page-container">
            ...
            <div class="media-container text-center">
                ...
                <section class="site-section site-section-light site-section-top">
                    <div class="container">
                        <h1 class="animation-slideDown"><strong>Pengumuman Kadar Bayaran bagi tahun 2018</strong></h1>
                        <h2 class="h3 animation-slideUp hidden-xs">Berkuatkuasa Januari 2018, terdapat kadar bayaran baru untuk lesen anjing.</h2>
                    </div>
                </section>
